...
${group == 'A' ? '<li style="padding-left:20px">Nachhaltigkeitsbewertung dargestellt als fünfstufige Farb- und Buchstabenskala, die einen Überblick über die Nachhaltigkeit eines Produktes liefert (E, D, C, B, A). Dabei ist A der beste und E der schlechteste Wert. Die Nachhaltigkeitsbewertung bezieht Erderwärmung, Feinstaubbelastung, Wassernutzung, Bodennutzung, Tierwohl und ob ein Produkt Bio ist mit ein. Detailliertere Informationen zur Nachhaltigkeit können durch bewegen der Maul über den entsprechenden Score angezeigt werden. Hierbei werden im grünen Kasten Labels angezeigt, die positiv auf die Nachhaltigkeit wirken (Tierwohl, Bio) und im roten Aspekte die negatriv wirken (Erderwärmung, Feinstaubbelastung, Wassernutzung, Bodennutzung) <img style="max-height:800px" src="'+chrome.runtime.getURL('task-AB-ch.png')+'"/></li>':'<img style="max-height:800px" src="'+chrome.runtime.getURL('task-C-ch.png')+'"/>'}
